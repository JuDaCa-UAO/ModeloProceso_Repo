...
export const MEDIA_MANIFEST = {
  ...
  [mediaKey("stage2.pughMatrix")]: {
    ...
    kind: "download",
    provider: "local",
    ref: "/media/descargables/etapa-2/matriz-pugh/matriz-pugh.pdf",
    availability: "available",
  ...
  [mediaKey("stage2.pughMatrixPreview")]: {
    ...
    kind: "image",
    provider: "local",
    ref: "/media/descargables/etapa-2/matriz-pugh/preview-matriz-pugh.png",
    availability: "available",
    width: 1687,
    height: 1093,
  ...
  [mediaKey("stage3.designCanvas")]: {
    ...
    kind: "download",
    provider: "local",
    ref: "/media/descargables/etapa-3/canvas-diseno/canvas-etapa-3-diseno.pdf",
    availability: "available",
  ...
  [mediaKey("stage3.designCanvasPreview")]: {
    ...
    kind: "image",
    provider: "local",
    ref: "/media/descargables/etapa-3/canvas-diseno/preview-canvas-etapa-3-diseno.png",
    availability: "available",
    width: 1754,
    height: 1464,
  ...
  [mediaKey("stage3.experienceMatrix")]: {
    ...
    kind: "download",
    provider: "local",
    ref: "/media/descargables/etapa-3/matriz-experiencia/matriz-de-la-experiencia.pdf",
    availability: "available",
  ...
  [mediaKey("stage3.experienceMatrixPreview")]: {
    ...
    kind: "image",
    provider: "local",
    ref: "/media/descargables/etapa-3/matriz-experiencia/preview-matriz-de-la-experiencia.png",
    availability: "available",
    width: 3455,
    height: 1102,
  ...
  [mediaKey("stage4.readinessCanvas")]: {
    ...
    kind: "download",
    provider: "local",
    ref: "/media/descargables/etapa-4/canvas-alistamiento/canvas-etapa-4-alistamiento.pdf",
    availability: "available",
  ...
  [mediaKey("stage4.readinessCanvasPreview")]: {
    ...
    kind: "image",
    provider: "local",
    ref: "/media/descargables/etapa-4/canvas-alistamiento/preview-canvas-etapa-4-alistamiento.png",
    availability: "available",
    width: 1754,
    height: 1464,
  ...
  [mediaKey("stage6.evaluationCanvas")]: {
    ...
    kind: "download",
    provider: "local",
    ref: "/media/descargables/etapa-6/canvas-evaluacion/canvas-etapa-6-evaluacion.pdf",
    availability: "available",
  ...
  [mediaKey("stage6.evaluationCanvasPreview")]: {
    ...
    kind: "image",
    provider: "local",
    ref: "/media/descargables/etapa-6/canvas-evaluacion/preview-canvas-etapa-6-evaluacion.png",
    availability: "available",
    width: 1754,
    height: 1464,
