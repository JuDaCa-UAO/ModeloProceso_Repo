...
function Orb({
  ...
  /** Selección delegada al componente de navegación que conoce las etapas. */
...
export default function SpiralModel({
  ...
  const { nodes, materials } = useGLTF("/media/compartido/modelos/espiral.glb") as unknown as GLTFResult;
...
useGLTF.preload("/media/compartido/modelos/espiral.glb");
